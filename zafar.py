...
os.system("clear")
print "\033[1;96m ============================================================="
print  """\033[1;96m [¤] \x1b[1;93mASSALAMUALAIKUM\x1b[1;96m  \033[1;96m   [¤] \x1b[1;93mWHATSAPP : +923100209977\x1b[1;96m  
\033[1;96m [¤] \x1b[1;93mSELAMAT DATAMG\x1b[1;96m      [¤] \x1b[1;93mFACEBOOK : tools termux\x1b[1;96m  
\033[1;96m [¤] \x1b[1;93mTOOLS MR.Zafar\x1b[1;96m  [¤] \x1b[1;93mYOUTUBE  : mr Zafar\x1b[1;96m"""
print " \x1b[1;93m============================================================="
...
loop = 'true'
while (loop == 'true'):
    username = raw_input("\033[1;96m[☆] \x1b[1;93mUSERNAME ENTER \x1b[1;96m>>>> ")
    if (username == CorrectUsername):
    	password = raw_input("\033[1;96m[☆] \x1b[1;93mPASSWORD ENTER \x1b[1;96m>>>> ")
...
def login():
	...
	try:
		...
		print logo
		print 42*"\033[1;96m="
		print('\033[1;96m[☆] \x1b[1;93mLOGIN ID FACEBOOK \x1b[1;96m[☆]' )
...
def pilih_super():
	...
	if peak =="":
		...
		print logo
		print 42*"\033[1;96m="
		idg=raw_input('\033[1;96m[+] \033[1;93mMEnter group ID \033[1;91m:\033[1;97m ')
		try:
